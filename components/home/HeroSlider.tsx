  ...
  return (
    <section className="relative w-full overflow-hidden bg-brand-black text-white">
      ...
      <div className="pointer-events-none absolute left-0 top-0 bottom-0 hidden w-20 xl:block">
        <div className="absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 -rotate-90 items-center gap-4 whitespace-nowrap text-[10px] font-semibold uppercase tracking-[0.42em] text-white/40">
          <span>Est · 2020</span>
      ...
      <div className="relative container-shop flex min-h-[80vh] flex-col justify-center py-20 sm:min-h-[86vh] lg:min-h-[92vh] lg:py-28">
        <div className="max-w-2xl animate-fade-up">
          ...
          <h1 className="font-display font-bold tracking-tightest leading-[0.96] text-[clamp(2.25rem,7vw,5rem)] text-white">
            <span className="block">Timeless Pakistani style,</span>
            <span className="block">
              crafted with <span className="italic text-brand-red">distinction.</span>
            </span>
          </h1>

          <p className="mt-6 max-w-xl text-sm leading-relaxed text-white/75 sm:text-base lg:text-lg">
            Discover premium waistcoats, Chitrali pakol caps, elegant shawls,
            fragrances, footwear, and refined everyday essentials — designed for
