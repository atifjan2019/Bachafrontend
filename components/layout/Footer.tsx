...
export async function Footer() {
  ...
  return (
    <footer className="bg-white border-t border-ink-10 pb-20 lg:pb-0">
      <div className="container-shop grid gap-12 lg:grid-cols-5 py-16">
        <div className="lg:col-span-2">
          <BrandMark size="xl" logoUrl={settings?.logo_url as string | undefined} />
        ...
        <div>
          ...
          <div className="flex items-center gap-3 mt-6">
            {settings?.instagram_url && (
              <a aria-label="Instagram" href={settings.instagram_url} className="text-ink-70 hover:text-brand-black" target="_blank" rel="noopener noreferrer">
                <Instagram className="h-5 w-5" />
              </a>
            )}
            {settings?.facebook_url && (
              <a aria-label="Facebook" href={settings.facebook_url} className="text-ink-70 hover:text-brand-black" target="_blank" rel="noopener noreferrer">
